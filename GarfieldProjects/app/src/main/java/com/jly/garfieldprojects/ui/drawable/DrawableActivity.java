...
public class DrawableActivity extends Activity {
    ...
    private void initView() {
        cicleIv = (ImageView) findViewById(R.id.cicleIv);
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.cat1);
        cicleIv.setImageDrawable(new CircleImageDrawable(bitmap));
        roundIv = (ImageView) findViewById(R.id.roundIv);
        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(), R.drawable.cat2);
        roundIv.setImageDrawable(new RoundImageDrawable(bitmap2));
    }
}
