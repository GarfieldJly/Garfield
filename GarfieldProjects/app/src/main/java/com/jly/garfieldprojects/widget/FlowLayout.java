 ...
 * @version V1.0
 * @classname: ${FILE_NAME}
 * @description: ${TODO}  流式布局,根据内容来确定View的大小
 */
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < numLines; i++) {
            ...
            for (int j = 0; j < children; j++) {
                ...
                child.layout(left + lp.leftMargin, top + lp.topMargin + gravityMargin + verticalGravityMargin, left + childWidth + lp.leftMargin, top
